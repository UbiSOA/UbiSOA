 ...
 * 
 */
public class UserEnvironmentHistory extends BaseResource {
    ...
    public UserEnvironmentHistory(Context context, Request request, Response response) {
    ...
    public Representation represent(Variant variant) throws ResourceException {
    	...
    	Property heartRate= model.createProperty(nm, "heartRate");
 		...
 		varTemperature = "28,29,20,10,15,25,40,20,25,30";
 		varRespiratoryRate = "80,90,100,120,70,60,50,20,30,10";
 		varBloodPresure = "100,100,90,80,70,50,60,90,80,90";
 		varHeartRate = "90,80,80,70,50,40,20,10,60,90";
