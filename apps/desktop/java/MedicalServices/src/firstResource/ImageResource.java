...
public class ImageResource extends BaseResource {
    ...
    public Representation represent(Variant variant) throws ResourceException {
    	...
    	QuerySample imageIdentify = new QuerySample("c:/java/lena.jpg");
    	System.out.println("Identificacion de la imagen: " + "\n" + imageIdentify.run());
        ...
        if (MediaType.TEXT_XML.equals(variant.getMediaType())) {
            try {
                ...
                //for (Item item : getItems().values()) {
                	...
                	Element eltName = d.createElement("name");
                	eltName.appendChild(d.createTextNode("Nombre del codigo, o algun identificador " ));
                    //eltName.appendChild(d.createTextNode(item.getName()));
                    eltItem.appendChild(eltName);

                    Element eltDescription = d.createElement("description");
                    eltDescription.appendChild(d.createTextNode("Aqui debe de ir el contenido de la identificacion de la imagen con PATH= " + path));
