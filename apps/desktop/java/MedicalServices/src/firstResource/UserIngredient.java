 ...
 * 
 */
public class UserIngredient extends BaseResource {
	
	static String user;
	static String ingredientCode;
	static String personIngredientURI    = "http://localhost:2122/ubicomp/users/";
    ...
    public UserIngredient(Context context, Request request, Response response) {
        ...
        ingredientCode =  request.getAttributes().get("ingredientCode").toString();  
        personIngredientURI =  personIngredientURI  +  user  + "/ingredients/" + ingredientCode;  
    }
    ...
    public Representation represent(Variant variant) throws ResourceException {
    	...
    	Property name= model.createProperty(nm, "name");
 		...
 		//Se crea el recurso
 		Resource ingredient = model.createResource(personIngredientURI);
        ...
        if (MediaType.TEXT_XML.equals(variant.getMediaType())) {
            try {
                ...
                Element nodeIngredient = d.createElement(ingredientCode);
                d.appendChild(nodeUbicomp);
                	...
                	nodeIngredient.appendChild(eltName);

                    Element eltPortion = d.createElement("portion");
                    eltPortion.appendChild(d.createTextNode(varPortion));
                    nodeIngredient.appendChild(eltPortion);
                    
                    nodeIngredients.appendChild(nodeIngredient);
