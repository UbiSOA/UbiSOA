...
public class QrcodeResource extends BaseResource {
    ...
    public QrcodeResource(Context context, Request request, Response response) {
        ...
        path = request.getResourceRef().getQueryAsForm().getFirstValue("path");
    }
    ...
    public Representation represent(Variant variant) throws ResourceException {
    	...
    	QRCodeDecoderCUIExample qr= new QRCodeDecoderCUIExample();
       	String qrcodeData= new String();
    	//qrcodeData = qr.FileDecode("C:/java/nombre.jpg");
       	qrcodeData = qr.FileDecode(path);
        ...
        if (MediaType.TEXT_XML.equals(variant.getMediaType())) {
            try {
                ...
                //for (Item item : getItems().values()) {
                    ...
                    eltDescription.appendChild(d.createTextNode(qrcodeData));
