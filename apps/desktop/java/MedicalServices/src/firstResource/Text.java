 ...
 * 
 */
public class Text extends BaseResource {
	
	static String textURI    = "http://localhost:2122/ubicomp/presentation/text";
	...
	//variable del texto que será presentado
	static String varText;
	
    public Text(Context context, Request request, Response response) {
    ...
    public Representation represent(Variant variant) throws ResourceException {
    	...
    	Property text= model.createProperty(nm, "text");
 		...
 		//Se crea el recurso
 		Resource txt = model.createResource(textURI);
 		
 		//Se asigna el valor a la variable
 		varText = "Aqui va el texto a desplegar";
 			
 		//Se agregan las propiedades
 		txt.addProperty(text, varText);
        ...
        if (MediaType.TEXT_XML.equals(variant.getMediaType())) {
            try {
            	...
            	d.appendChild(nodeUbicomp);
            		...
            		Element nodeAudio = d.createElement("text");
