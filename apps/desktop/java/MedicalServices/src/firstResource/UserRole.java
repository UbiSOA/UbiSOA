 ...
 * 
 */
public class UserRole extends BaseResource {

	String user;
	static String varRole;
	static String personRoleURI    = "http://localhost:2122/ubicomp/users/";
    ...
    public UserRole(Context context, Request request, Response response) {
        ...
        personRoleURI = personRoleURI + user + "/role";
    ...
    public Representation represent(Variant variant) throws ResourceException {
    	...
    	//Properties
    	Property role= model.createProperty(nm, "role");
        ...
        if (MediaType.TEXT_XML.equals(variant.getMediaType())) {
            try {
                ...
                d.appendChild(nodeUbicomp);
                	...
                	Element nodeRole = d.createElement("role");

                    
                	Element eltRole = d.createElement("role");
                	eltRole.appendChild(d.createTextNode(varRole));
                	nodeRole.appendChild(eltRole);
                        
                    nodeUser.appendChild(nodeRole);
