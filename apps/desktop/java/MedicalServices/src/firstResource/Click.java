 ...
 * 
 */
public class Click extends BaseResource {
	
	static String clickURI    = "http://localhost:2122/ubicomp/event/click";
    ...
    public Click(Context context, Request request, Response response) {
    ...
    public Representation represent(Variant variant) throws ResourceException {
    	...
    	Property url= model.createProperty(nm, "url");
 		...
 		//Se crea el recurso
 		Resource eventClick = model.createResource(clickURI);
 		...
 		eventClick.addProperty(file,varFile);
 		eventClick.addProperty(url, varURL);
